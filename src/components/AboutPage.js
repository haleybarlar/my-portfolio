    ...
    return (
      <div className="about-page">
        ...
        <div className="about-text">
          <p>I’m a front end web developer who believes in the power of good design.  Even the most useful app can be sabotaged by a lack of margins or Comic Sans, and I feel it's my civic duty to prevent this from happening.</p>
